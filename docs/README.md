...
| File | Contents |
|---|---|
| [setup.md](setup.md) | environment pins, the certificate workaround, how to run batches, two traps |
| [concepts.md](concepts.md) | what the project does in machine learning terms, plus a glossary of every term |
